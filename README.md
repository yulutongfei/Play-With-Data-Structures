...
| 补充代码5: 数组链表 | [整理中，敬请期待] |
| **第六章 二分搜索树** | [章节Java源码](src/main/java/com/sunxu/binarysearchtree) |
| 6-1 为什么要研究树结构 | [无代码] |
| 6-2 二分搜索树基础 | [Java](src/main/java/com/sunxu/binarysearchtree/binarysearchtreebasis) |
| 6-3 向二分搜索树中添加元素 | [Java](src/main/java/com/sunxu/binarysearchtree/addelementsinbst) |
| 6-4 改进添加操作：深入理解递归终止条件 | [Java](src/main/java/com/sunxu/binarysearchtree/improvedaddelementsinbst) |
| 6-5 二分搜索树的查询操作 | [Java](src/main/java/com/sunxu/binarysearchtree/searchinbst) |
| 6-6 二分搜索树的前序遍历 | [Java](src/main/java/com/sunxu/binarysearchtree/preordertraverseinbst) |
| 6-7 二分搜索树的中序遍历和后序遍历 | [Java](src/main/java/com/sunxu/binarysearchtree/inorderandpostordertraverseinbst) |
| 6-8 深入理解二分搜索树的前中后序遍历 | [无代码] |
| 6-9 二分搜索树前序遍历的非递归实现 | [Java](src/main/java/com/sunxu/binarysearchtree/nonrecursionpreordertraverseinbst) |
| 6-10 二分搜索树的层序遍历 | [Java](src/main/java/com/sunxu/binarysearchtree/leveltraverseinbst) |
| 6-11 删除二分搜索树的最大元素和最小元素 | [Java](src/main/java/com/sunxu/binarysearchtree/removeminandmaxinbst) |
| 6-12 删除二分搜索树的任意元素 | [Java](src/main/java/com/sunxu/binarysearchtree/removeelementsinbst) |
